...
#ifndef _ANDROID_MEDIA_MEDIA_ENCODEC_H_
#define _ANDROID_MEDIA_MEDIA_ENCODEC_H_
...
struct GMediaEncodec : public RefBase 
{
    GMediaEncodec( const char *name, bool nameIsType, bool encoder);
...
private:
    ...
    DISALLOW_EVIL_CONSTRUCTORS(GMediaEncodec);
};
