...
sp<Camera> get_native_camera(JNIEnv *env, jobject thiz, JNICameraContext** pContext)
{
    ...
    ALOGE("get_native_camera: context=%p, camera=%p", context, camera.get());
    if (camera == 0) {
...
static jboolean 
android_hardware_Camera_isPlayingCamera(JNIEnv *env, jobject thiz)
{
    ALOGV("isPlayingCamera");
    sp<Camera> camera = get_native_camera(env, thiz, NULL);
    if (camera == 0) return 0;
    
    bool playing;
    if( OK != camera->isPlayingCamera(&playing) ){
        ALOGV("Fail in isPlayingCamera()");
        playing = false;
    }
...
static JNINativeMethod camMethods[] = {
  ...
  { "isPlayingCamera",     
    "()Z",                              
    (void *)android_hardware_Camera_isPlayingCamera},
  /* add by Michael. end   -----------------------------------}} */
  { "lock",
    "()V",
...
int register_android_hardware_Camera(JNIEnv *env)
{
    field fields_to_find[] = {
        { "com/great/happyness/Codec/GreatCamera", "mNativeContext",   "I", &fields.context },
        ...
        { "com/great/happyness/Codec/GreatCamera$CameraInfo", "facing",   "I", &fields.facing },
        { "com/great/happyness/Codec/GreatCamera$CameraInfo", "orientation",   "I", &fields.orientation },
        { "com/great/happyness/Codec/GreatCamera$CameraInfo", "canDisableShutterSound",   "Z",
          &fields.canDisableShutterSound },
        { "com/great/happyness/Codec/GreatCamera$Face", "rect", "Landroid/graphics/Rect;", &fields.face_rect },
        { "com/great/happyness/Codec/GreatCamera$Face", "score", "I", &fields.face_score },
    ...
    jclass clazz = env->FindClass("com/great/happyness/Codec/GreatCamera");
    ...
    return AndroidRuntime::registerNativeMethods(env, "com/great/happyness/Codec/GreatCamera",
													camMethods, NELEM(camMethods));
}

int registerCamera(JNIEnv *env) 
{
